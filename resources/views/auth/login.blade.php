...
@endsection
@section('content')
<form action="{{route('authenticate')}}" method="post" onsubmit="return validate(this);">
	@csrf
	...
	<div class="col-lg-6">
	    <div class="card2 card border-0 px-4 py-5">
	        ...
	        <div class="row px-3"> 
	            ...
	            <input type="password" name="password" placeholder="Enter password" class="req" minlength="6"> 
	            <span class="err text-danger">{{ $errors->first('password') }}</span>
	        </div>
	        <div class="row mb-3 px-3"> <button type="submit" class="btn btn-blue text-center">Login</button> </div>
	        <div class="row mb-4 px-3"><small class="font-weight-bold"> <a class="text-danger " href="{{route('forgot-password')}}">Forgot Password</a> <small class="font-weight-bold">Don't have an account? <a class="text-danger " href="{{route('register')}}">Register</a></small> </div>
	    </div>
	</div>
</form>
@endsection
